            ...
            <section className="card">
              ...
              <div className="field">
                ...
                <div className="affix locked">
                  ...
                  <input className="ip" placeholder="hjKm3vX9…NOUNS" disabled />
                </div>
                <p className="hint">
                  Soon you&apos;ll pick a vanity ending for your pad — and every
                  token minted on it will get an address finishing with it.
                </p>
              </div>
